Feature: Create User
  ...
  Scenario: Payload using Unsupported Media Type
    ...
    And sends the request Then our API should respond with a 415 HTTP status code
    And the payload of the response should be a JSON object
  ...
  Scenario: Malformed JSON Payload
    ...
    And sends the request Then our API should respond with a 400 HTTP status code
    And the payload of the response should be a JSON object
